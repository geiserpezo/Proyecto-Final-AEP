...
print("Agiliza tu mente es un juego matematico donde se pone en desafio tu capacidad de resolver operaciones combinadas en el menor tiempo posible")
...
while True:
    ...
    if de == "no":
        ...
        print("Responda lo mas rapido posible")
        jugar= "si"
        while jugar=="si":
            inicio=time.time()
